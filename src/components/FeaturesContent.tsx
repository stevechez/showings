  ...
  return (
    <section className="w-full bg-white py-14">
      <div className="mx-auto max-w-7xl px-10">
        <div className="mb-8 space-y-5 bg-blue-50 p-4 lg:mb-16 lg:px-0 lg:text-center">
          <h2 className="text-4xl font-bold sm:text-5xl">Features</h2>
        </div>
        <div className="grid overflow-hidden lg:rounded-xl">
          <div className="grid items-center lg:grid-cols-2">
            <div className="flex h-full flex-col items-start justify-center space-y-4 bg-white py-16 pl-16 pr-16 sm:pr-4 lg:py-0 lg:pr-20">
          ...
          <div className="grid items-center lg:grid-cols-2">
            <div className="order-last h-96 overflow-hidden lg:order-first">
              <Image
                src="/assets/features2.avif"
                className="h-full w-full object-cover"
                width={400}
                height={300}
                alt=""
            ...
            <div className="flex h-full flex-col items-start justify-center space-y-4 bg-gray-100 py-16 pl-16 pr-16 lg:py-0 lg:pr-20">
              <h3 className="bg-gray-100 text-2xl font-semibold sm:text-4xl">
                Collaboration
              </h3>
